    ...
    try {
      ...
      if (data) {
        setFormData({
          ...
          credits: data.course?.credits?.toString() || '',
          ...
          yearLevel: data.academicDetails?.yearLevel?.toString() || '',
          semester: data.academicDetails?.semester || '',
          academicYear: data.academicDetails?.academicYear || '',
          program: data.academicDetails?.program || ''
        });
      }
    } catch (error) {
